...
First off, thank you for considering contributing to USay! It's people like you that make this package better for everyone.
...
- [Ask a question](https://github.com/maiHydrogen/USay/issues)
- [Submit a bug report](https://github.com/maiHydrogen/USay/issues)
- [Request a new feature](https://github.com/maiHydrogen/USay/issues/new/choose)
- [Suggest ways to improve the developer experience of an existing feature](https://github.com/maiHydrogen/USay/issues/new/choose)
- Add documentation
...
You can find all existing issues [here](https://github.com/maiHydrogen/USay/issues). 
...
**Step 3** - Fork the [`maiHydrogen/USay`](https://github.com/maiHydrogen/USay) repo to your account.  
...
**Step 1** - Open an [issue](https://github.com/maiHydrogen/USay/issues/new/choose) so that we can discuss on the new feature.  
**Step 2** - Fork the [`maiHydrogen/USay`](https://github.com/maiHydrogen/USay) repo to your account.  
